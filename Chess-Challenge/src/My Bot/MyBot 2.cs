...
public class [System.Serializable]
public class MyBot 2Exception : System.Exception
{
    public MyBot 2Exception() { }
    public MyBot 2Exception(string message) : base(message) { }
    public MyBot 2Exception(string message, System.Exception inner) : base(message, inner) { }
    protected MyBot 2Exception(
